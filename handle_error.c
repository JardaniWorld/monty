...
/**
 * handle_error - This function manages the printing of interpreter errors
 *
...
/**
 * handle_cerror - This funcion manages common interpreter errors
 *
 * @errno: The error code to manage
 * @opcode: The operation code to manage
 * @line: The line on which the error occurred
...
/**
 * handle_uerror - This function manages interpreter usage errors
 *
 * @errno: The error code to manage
 * @line: The line on which the error occurred
 *
...
/**
 * handle_more_uerror - This function manages interpreter usage errors
 *
 * @errno: The error code to manage
 * @line: The line on which the error occurred
 *
