...
/**
 * check_args_num - This function checks the arguments
 * passed on to the interpreter
 *
...
/**
 * check_access_rights - This function checks if the
 * user has permissions to read the file
 *
...
/**
 * check_push_param - This function checks the
 * parameter of the push instruction
 *
...
/**
 * check_digits - This function checks if all characters
